    ...
    for currBase=1:lenHelix
        if jsonData.vstrands{currHelix}.doubleStranded(currBase)==1
            ...
            if strand==1
                strand=0;
                endPos=currBase;
                fprintf( fileId, '<rect x="%f" y="%f" width="%f" height="%f" fill="url(#grad2)" stroke-width="0.0" stroke="none"/>\n' ...
    ...
    for currBase=lenHelix:-1:1
        if jsonData.vstrands{currHelix}.doubleStranded(currBase)==1
            ...
            if strand==1
                strand=0;
                endPos=currBase;
                fprintf( fileId, '<circle cx="%f" cy="%f" r="%f" fill="url(#color2)" stroke-width="0.0" stroke="none"/>\n' ...
    ...
    for currBase=lenHelix:-1:1
        if jsonData.vstrands{currHelix}.doubleStranded(currBase)==1
            ...
            if strand==1
                strand=0;
                endPos=currBase;
                fprintf( fileId, '<circle cx="%f" cy="%f" r="%f" fill="url(#grad2)" stroke-width="0.0" stroke="none" transform="rotate(-45,%f,%f)"/>\n' ...
                ...
                fprintf( fileId, '<circle cx="%f" cy="%f" r="%f" fill="url(#color2)" stroke-width="0.05" stroke="black"/>\n' ...
